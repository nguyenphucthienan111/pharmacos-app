...
const ProfileScreen = ({ navigation }) => {
  ...
  // Define styles inside the component to ensure access to theme
  const styles = StyleSheet.create({
    ...
    header: {
      ...
      alignItems: "center",
      paddingTop: Platform.OS === 'ios' ? 50 : 30, // Extra padding for iOS notch
    },
    avatarContainer: {
      width: 100,
      height: 100,
  ...
  // Handle the case when user or user.profile is undefined
