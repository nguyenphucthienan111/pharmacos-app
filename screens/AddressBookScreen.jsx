      ...
      <View style={styles.modalContainer}>
        <View style={styles.modalContent}>
          ...
          <ScrollView keyboardShouldPersistTaps="handled">
            ...
            >
              <Text
                style={{ color: formData.city ? "#333" : "#888", fontSize: 16 }}
              >
            ...
            >
              <Text
                style={{
                  color: formData.district ? "#333" : "#888",
                  fontSize: 16,
                }}
              >
            ...
            >
              <Text
                style={{ color: formData.ward ? "#333" : "#888", fontSize: 16 }}
              >
            ...
            <View style={styles.addressTypeContainer}>
              {addressTypeOptions.map((opt) => (
                <TouchableOpacity
                  ...
                  onPress={() =>
                    setFormData((p) => ({ ...p, addressType: opt.value }))
                  }
                >
                  <Text
                    style={[
...
const luxuryStyles = StyleSheet.create({
  ...
  addressName: { fontSize: 17, fontWeight: "bold", color: luxuryColors.navy },
  addressText: { fontSize: 15, color: "#555", marginBottom: 4, lineHeight: 20 },
  addressActions: {
    flexDirection: "row",
    ...
    marginTop: 12,
    borderTopWidth: 1,
    borderTopColor: luxuryColors.goldLight,
    paddingTop: 12,
  },
  defaultBadge: {
  ...
  typeBadgeText: { fontSize: 13, fontWeight: "bold", color: "#fff" },
  emptyText: {
    textAlign: "center",
    marginTop: 50,
    fontSize: 16,
...
const AddressBookScreen = () => {
  ...
  const renderAddress = ({ item }) => (
    <View style={luxuryStyles.addressCard}>
      <View style={luxuryStyles.addressHeader}>
        <Text style={luxuryStyles.addressName}>{item.name}</Text>
        {item.isDefault && (
          <View style={luxuryStyles.defaultBadge}>
            <Text style={luxuryStyles.defaultBadgeText}>Default</Text>
          </View>
        )}
      </View>
      <Text style={luxuryStyles.addressText}>{item.phone}</Text>
      <Text
        style={luxuryStyles.addressText}
      >{`${item.address}, ${item.ward}, ${item.district}, ${item.city}`}</Text>
      {item.addressType && (
        <View style={luxuryStyles.typeBadge}>
          <Text style={luxuryStyles.typeBadgeText}>{item.addressType}</Text>
        </View>
      )}
      <View style={luxuryStyles.addressActions}>
        <TouchableOpacity
          onPress={() => {
        ...
        >
          <Feather name="edit-2" size={20} color={luxuryColors.navy} />
        </TouchableOpacity>
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: luxuryColors.bg }}>
      ...
      >
        ...
        <Text style={luxuryStyles.addButtonText}>Add New Address</Text>
      </TouchableOpacity>
      {loading ? (
        <ActivityIndicator
          size="large"
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <Text style={luxuryStyles.emptyText}>
